...
V1 envelope objects are restricted to I-JSON-compatible strings, integers, arrays, and objects. No floating-point value, duplicate member name, non-UTF-8 text, or non-finite number is permitted in a hashed object. JCS is applied recursively, with lexicographic property ordering and no insignificant whitespace.
